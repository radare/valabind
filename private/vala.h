...
ValaArrayCopyMethod* vala_array_copy_method_construct (GType object_type, ValaSourceReference* source_reference);
...
ValaBinaryExpression* vala_binary_expression_new_chained (ValaBinaryOperator op, ValaExpression* _left, ValaExpression* _right, ValaSourceReference* source);
ValaBinaryExpression* vala_binary_expression_construct_chained (GType object_type, ValaBinaryOperator op, ValaExpression* _left, ValaExpression* _right, ValaSourceReference* source);
...
void vala_callable_add_parameter (ValaCallable* self, ValaParameter* param);
ValaList* vala_callable_get_parameters (ValaCallable* self);
ValaDataType* vala_callable_get_return_type (ValaCallable* self);
void vala_callable_set_return_type (ValaCallable* self, ValaDataType* value);
...
ValaCastExpression* vala_cast_expression_new (ValaExpression* inner, ValaDataType* type_reference, ValaSourceReference* source_reference);
ValaCastExpression* vala_cast_expression_construct (GType object_type, ValaExpression* inner, ValaDataType* type_reference, ValaSourceReference* source_reference);
...
gchar** vala_code_context_get_vapi_directories (ValaCodeContext* self, int* result_length1);
void vala_code_context_set_vapi_directories (ValaCodeContext* self, gchar** value, int value_length1);
gchar** vala_code_context_get_gir_directories (ValaCodeContext* self, int* result_length1);
void vala_code_context_set_gir_directories (ValaCodeContext* self, gchar** value, int value_length1);
gchar** vala_code_context_get_metadata_directories (ValaCodeContext* self, int* result_length1);
void vala_code_context_set_metadata_directories (ValaCodeContext* self, gchar** value, int value_length1);
...
GParamSpec* vala_param_spec_report (const gchar* name, const gchar* nick, const gchar* blurb, GType object_type, GParamFlags flags);
void vala_value_set_report (GValue* value, gpointer v_object);
void vala_value_take_report (GValue* value, gpointer v_object);
...
gchar** vala_code_context_get_gresources (ValaCodeContext* self, int* result_length1);
void vala_code_context_set_gresources (ValaCodeContext* self, gchar** value, int value_length1);
gchar** vala_code_context_get_gresources_directories (ValaCodeContext* self, int* result_length1);
void vala_code_context_set_gresources_directories (ValaCodeContext* self, gchar** value, int value_length1);
...
void vala_code_generator_store_local (ValaCodeGenerator* self, ValaLocalVariable* local, ValaTargetValue* value, gboolean initializer, ValaSourceReference* source_reference);
ValaTargetValue* vala_code_generator_load_parameter (ValaCodeGenerator* self, ValaParameter* param);
void vala_code_generator_store_parameter (ValaCodeGenerator* self, ValaParameter* param, ValaTargetValue* value, gboolean capturing_parameter, ValaSourceReference* source_reference);
ValaTargetValue* vala_code_generator_load_field (ValaCodeGenerator* self, ValaField* field, ValaTargetValue* instance);
void vala_code_generator_store_field (ValaCodeGenerator* self, ValaField* field, ValaTargetValue* instance, ValaTargetValue* value, ValaSourceReference* source_reference);
...
void vala_generic_type_set_type_parameter (ValaGenericType* self, ValaTypeParameter* value);
...
void vala_local_variable_set_init (ValaLocalVariable* self, gboolean value);
...
GParamSpec* vala_param_spec_markup_reader (const gchar* name, const gchar* nick, const gchar* blurb, GType object_type, GParamFlags flags);
void vala_value_set_markup_reader (GValue* value, gpointer v_object);
void vala_value_take_markup_reader (GValue* value, gpointer v_object);
...
ValaMarkupReader* vala_markup_reader_new_from_string (const gchar* filename, const gchar* content);
ValaMarkupReader* vala_markup_reader_construct_from_string (GType object_type, const gchar* filename, const gchar* content);
...
gboolean vala_report_set_colors (ValaReport* self, const gchar* str, ValaReportColored colored_output);
...
void vala_semantic_analyzer_add_replaced_node (ValaSemanticAnalyzer* self, ValaCodeNode* node);
...
void vala_source_file_set_explicit (ValaSourceFile* self, gboolean value);
